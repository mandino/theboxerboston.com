...
namespace DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Cipher;
 ...
 */
class Cbc implements \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Cipher\CipherMethod
{
    const BLOCK_SIZE = 16;
    /**
     * @var string
