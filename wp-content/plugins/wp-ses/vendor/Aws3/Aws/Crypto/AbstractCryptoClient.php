...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Cipher\CipherMethod;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\Cipher\Cbc;
...
abstract class AbstractCryptoClient
{
     ...
     * @internal
     */
    public abstract function encrypt(\DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Psr7\Stream $plaintext, array $cipherOptions, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MaterialsProvider $provider, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MaterialsProvider $provider, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Crypto\MetadataEnvelope $envelope, array $cipherOptions = []);
}
