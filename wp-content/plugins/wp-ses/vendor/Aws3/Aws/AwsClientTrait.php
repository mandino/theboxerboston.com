...
trait AwsClientTrait
{
    public function getPaginator($name, array $args = [])
    {
        ...
        return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ResultPaginator($this, $name, $args, $config);
    }
    ...
    public function getWaiter($name, array $args = [])
    {
        ...
        return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Waiter($this, $name, $args, $config);
    }
    public function execute(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $command)
    {
        return $this->executeAsync($command)->wait();
    }
    public function executeAsync(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $command)
    {
