...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Serializer\QuerySerializer;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Serializer\Ec2ParamBuilder;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Parser\QueryParser;
/**
 * Represents a web service API model.
 */
class Service extends \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\AbstractModel
{
    /** @var callable */
    private $apiProvider;
    /** @var string */
    ...
    public function __construct(array $definition, callable $provider)
    {
        ...
        parent::__construct($definition, new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\ShapeMap($definition['shapes']));
     ...
     */
    public static function createSerializer(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Service $api, $endpoint)
    {
        static $mapping = ['json' => 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Api\\Serializer\\JsonRpcSerializer', 'query' => 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Api\\Serializer\\QuerySerializer', 'rest-json' => 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Api\\Serializer\\RestJsonSerializer', 'rest-xml' => 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Api\\Serializer\\RestXmlSerializer'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api, $endpoint);
        }
        if ($proto == 'ec2') {
            return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Serializer\QuerySerializer($api, $endpoint, new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Serializer\Ec2ParamBuilder());
        }
     ...
     * @throws \UnexpectedValueException
     */
    public static function createParser(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Service $api)
    {
        static $mapping = ['json' => 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Api\\Parser\\JsonRpcParser', 'query' => 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Api\\Parser\\QueryParser', 'rest-json' => 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Api\\Parser\\RestJsonParser', 'rest-xml' => 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\Api\\Parser\\RestXmlParser'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api);
        }
        if ($proto == 'ec2') {
            return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Parser\QueryParser($api, null, false);
        }
        throw new \UnexpectedValueException('Unknown protocol: ' . $api->getProtocol());
    }
    /**
    ...
    public function getOperation($name)
    {
        if (!isset($this->operations[$name])) {
            ...
            $this->operations[$name] = new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\Operation($this->definition['operations'][$name], $this->shapeMap);
        }
