 ...
 */
class Shape extends \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\AbstractModel
{
    /**
     ...
     */
    public static function create(array $definition, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Api\ShapeMap $shapeMap)
    {
