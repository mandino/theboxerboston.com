...
class History implements \Countable, \IteratorAggregate
{
     ...
     */
    public function start(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $cmd, \DeliciousBrains\WP_Offload_SES\Aws3\Psr\Http\Message\RequestInterface $req)
    {
        $ticket = uniqid();
