 ...
 * AWS result.
 */
class Result implements \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ResultInterface
{
    use HasDataTrait;
    ...
    {
        return \DeliciousBrains\WP_Offload_SES\Aws3\JmesPath\Env::search($expression, $this->toArray());
    }
