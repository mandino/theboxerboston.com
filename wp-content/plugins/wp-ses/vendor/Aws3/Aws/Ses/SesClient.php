...
namespace DeliciousBrains\WP_Offload_SES\Aws3\Aws\Ses;
 ...
 */
class SesClient extends \DeliciousBrains\WP_Offload_SES\Aws3\Aws\AwsClient
{
    /**
     ...
     * @return string
     */
    public static function generateSmtpPassword(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Credentials\CredentialsInterface $creds)
    {
        static $version = "\2";
        static $algo = 'sha256';
