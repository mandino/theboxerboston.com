...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\PartitionInterface;
class MultiRegionClient implements \DeliciousBrains\WP_Offload_SES\Aws3\Aws\AwsClientInterface
{
    use AwsClientTrait;
    ...
    {
        $args = array_intersect_key(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\ClientResolver::getDefaultArguments(), ['service' => true, 'region' => true]);
        ...
        }], 'partition' => ['type' => 'config', 'valid' => ['string', \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\PartitionInterface::class], 'doc' => 'AWS partition to connect to. Valid partitions' . ' include "aws," "aws-cn," and "aws-us-gov." Used to' . ' restrict the scope of the mapRegions method.', 'default' => function (array $args) {
            $region = isset($args['region']) ? $args['region'] : '';
            return \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\PartitionEndpointProvider::defaultProvider()->getPartition($region, $args['service']);
        }, 'fn' => function ($value, array &$args) {
            if (is_string($value)) {
                $value = \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\PartitionEndpointProvider::defaultProvider()->getPartitionByName($value);
            }
    ...
    public function __construct(array $args = [])
    {
        ...
        $this->handlerList = new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\HandlerList(function (\DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $command) {
        ...
        $resolver = new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\ClientResolver($argDefinitions);
