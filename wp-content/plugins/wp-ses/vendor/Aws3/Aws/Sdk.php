...
class Sdk
{
    ...
    public function createClient($name, array $args = [])
    {
        ...
        $client = "DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\{$namespace}\\{$namespace}Client";
    ...
    public function createMultiRegionClient($name, array $args = [])
    {
        ...
        $service = manifest($name);
        $namespace = $service['namespace'];
        $klass = "DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\{$namespace}\\{$namespace}MultiRegionClient";
        $klass = class_exists($klass) ? $klass : 'DeliciousBrains\\WP_Offload_SES\\Aws3\\Aws\\MultiRegionClient';
