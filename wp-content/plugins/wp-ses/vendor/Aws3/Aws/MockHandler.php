...
class MockHandler implements \Countable
{
    ...
    public function __invoke(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $command, \DeliciousBrains\WP_Offload_SES\Aws3\Psr\Http\Message\RequestInterface $request)
    {
        ...
        if ($result instanceof \Exception) {
            $result = new \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\RejectedPromise($result);
        } else {
            ...
            $result = \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\promise_for($result);
        }
