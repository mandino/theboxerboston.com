 ...
 */
class CommandPool implements \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\PromisorInterface
{
    /** @var EachPromise */
    private $each;
    /**
     ...
     */
    public function __construct(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\AwsClientInterface $client, $commands, array $config = [])
    {
        ...
        $this->each = new \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\EachPromise($mapFn($commands), $config);
    }
    /**
     ...
     */
    public static function batch(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\AwsClientInterface $client, $commands, array $config = [])
    {
        $results = [];
