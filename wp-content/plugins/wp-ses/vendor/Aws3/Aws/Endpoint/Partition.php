...
use ArrayAccess;
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\HasDataTrait;
use InvalidArgumentException as Iae;
/**
 * Default implementation of an AWS partition.
 */
final class Partition implements \ArrayAccess, \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Endpoint\PartitionInterface
{
    use HasDataTrait;
    /**
