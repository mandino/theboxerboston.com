...
class ResultPaginator implements \Iterator
{
     ...
     * @param array              $config
     */
    public function __construct(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\AwsClientInterface $client, $operation, array $args, array $config)
    {
        $this->client = $client;
    ...
    {
        return \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\coroutine(function () use($handleResult) {
            $nextToken = null;
            do {
                ...
                if ($retVal !== null) {
                    (yield \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\promise_for($retVal));
                }
            } while ($nextToken);
        });
    }
    ...
    public function search($expression)
    {
        ...
        return flatmap($this, function (\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Result $result) use($expression) {
    ...
    private function determineNextToken(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Result $result)
    {
