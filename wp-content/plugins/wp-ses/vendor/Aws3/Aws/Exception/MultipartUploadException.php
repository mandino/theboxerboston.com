...
use DeliciousBrains\WP_Offload_SES\Aws3\Aws\Multipart\UploadState;
class MultipartUploadException extends \RuntimeException
{
     ...
     */
    public function __construct(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\Multipart\UploadState $state, $prev = null)
    {
