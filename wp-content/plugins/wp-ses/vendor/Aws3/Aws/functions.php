...
{
    $version = (string) \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\ClientInterface::VERSION;
    if ($version[0] === '5') {
        return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Handler\GuzzleV5\GuzzleHandler();
    }
    if ($version[0] === '6') {
        return new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Handler\GuzzleV6\GuzzleHandler();
    }
 ...
 */
function serialize(\DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $command)
{
    $request = null;
    $handlerList = $command->getHandlerList();
    // Return a mock result.
    $handlerList->setHandler(function (\DeliciousBrains\WP_Offload_SES\Aws3\Aws\CommandInterface $_, \DeliciousBrains\WP_Offload_SES\Aws3\Psr\Http\Message\RequestInterface $r) use(&$request) {
        $request = $r;
        return new \DeliciousBrains\WP_Offload_SES\Aws3\GuzzleHttp\Promise\FulfilledPromise(new \DeliciousBrains\WP_Offload_SES\Aws3\Aws\Result([]));
    });
