...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \DeliciousBrains\WP_Offload_SES\Aws3\JmesPath\Lexer();
        $this->parser = new \DeliciousBrains\WP_Offload_SES\Aws3\JmesPath\Parser($this->lexer);
    }
    ...
    {
        $lexer = new \DeliciousBrains\WP_Offload_SES\Aws3\JmesPath\Lexer();
    ...
    {
        $parser = new \DeliciousBrains\WP_Offload_SES\Aws3\JmesPath\Parser();
