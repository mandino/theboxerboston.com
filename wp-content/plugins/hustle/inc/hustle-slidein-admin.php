...
if ( ! class_exists( 'Hustle_Slidein_Admin' ) ) :
	 ...
	 */
	class Hustle_Slidein_Admin extends Hustle_Admin_Common {
		...
		public function register_admin_menu() {
			// Optins
			$this->page_slug = add_submenu_page( 'hustle', __( 'Slide-ins', Opt_In::TEXT_DOMAIN ) , __( 'Slide-ins', Opt_In::TEXT_DOMAIN ) , 'hustle_edit_module', Hustle_Module_Admin::SLIDEIN_LISTING_PAGE,  array( $this, 'render_slidein_listing' ) );
			add_submenu_page( 'hustle', __( 'New Slide-in', Opt_In::TEXT_DOMAIN ) , __( 'New Slide-in', Opt_In::TEXT_DOMAIN ) , 'hustle_create', Hustle_Module_Admin::SLIDEIN_WIZARD_PAGE,  array( $this, 'render_slidein_wizard_page' ) );
		...
		public function register_current_json( $current_array ) {
			...
			} elseif ( Hustle_Module_Admin::SLIDEIN_LISTING_PAGE === $_GET['page'] ) { // CSRF: ok.
				$current_array['current'] = array( 'wizard_page' => Hustle_Module_Admin::SLIDEIN_WIZARD_PAGE );
			}
		...
		public function check_if_module_exists() {
			if ( isset( $_GET['page'] ) && Hustle_Module_Admin::SLIDEIN_WIZARD_PAGE === $_GET['page'] ) { // WPCS: CSRF ok.
				...
				if ( is_wp_error( $module ) ) {
					...
					$url = add_query_arg( array(
						'page' => Hustle_Module_Admin::SLIDEIN_LISTING_PAGE,
