		...
		<div class="sui-slider">
			...
			<ul class="sui-slider-content" role="document">
				...
				<li <?php if ( ! $is_first_time_opening ) echo 'class="sui-current sui-loaded" '; ?>data-slide="2">
					...
					<div class="sui-box">
						...
						<div class="sui-box-header sui-lg sui-block-content-center">
							...
							<h2
								id="dialogTitle"
								class="sui-box-title"
								data-done-text="<?php esc_html_e( 'Migration complete', Opt_In::TEXT_DOMAIN ); ?>"
							>
								<?php esc_html_e( 'Migrate Data', Opt_In::TEXT_DOMAIN ); ?>
							</h2>

							<span
								id="dialogDescription"
								class="sui-description"
								data-default-text="<?php esc_html_e( 'Nice work on updating the Hustle! All your modules are already in place. However, You need to migrate the data of your existing modules such as tracking data and email list manually.', Opt_In::TEXT_DOMAIN ); ?>"
								data-migrate-text="<?php esc_html_e( 'Data migration is in progress. It can take anywhere from a few seconds to a couple of hours depending upon the data of your existing modules and traffic on your site.', Opt_In::TEXT_DOMAIN ); ?>"
								data-done-text="<?php esc_html_e( "We've successfully migrated your existing data. You're good to continue using Hustle!", Opt_In::TEXT_DOMAIN ); ?>"
							><?php esc_html_e( 'Nice work on updating the Hustle! All your modules are already in place. However, You need to migrate the data of your existing modules such as tracking data and email list manually.', Opt_In::TEXT_DOMAIN ); ?></span>
						...
						<div class="sui-box-body sui-block-content-center sui-lg sui-last" data-migrate-start>
							...
							>
								<span class="sui-loading-text">
									<?php esc_html_e( 'Begin Migration', Opt_In::TEXT_DOMAIN ); ?>
									<i class="sui-icon-chevron-right" aria-hidden="true"></i>
								</span>
						...
						<div class="sui-box-body sui-block-content-center sui-lg sui-last sui-hidden" data-migrate-failed>
							...
							<div class="sui-notice sui-notice-error">
								<p><?php printf( esc_html__( 'There was an error while migrating your data. Please retry again or contact our %1$ssupport%2$s team for help.', Opt_In::TEXT_DOMAIN ), '<a href="' . esc_url( $support_link ) . '" target="_blank">', '</a>' ); ?></p>
							</div>
							...
							>
								<span class="sui-loading-text">
									<?php esc_html_e( 'Retry Migration', Opt_In::TEXT_DOMAIN ); ?>
								</span>
								<i class="sui-icon-loader sui-loading"></i>
							</button>
							
							<span class="sui-description" style="margin: 10px 0 0;"><?php esc_html_e( 'The migration will continue from where it failed in the last attempt.', self::TEXT_DOMAIN ); ?></span>
						...
						<div class="sui-box-body sui-block-content-center sui-lg sui-last sui-hidden" data-migrate-done>
							...
							<button class="sui-button" data-a11y-dialog-tour-next>
								<?php esc_html_e( 'Continue', Opt_In::TEXT_DOMAIN ); ?>
							</button>
					...
					<p class="sui-onboard-skip"><a href="#" data-a11y-dialog-hide="hustle-dialog--migrate"><?php esc_html_e( "Skip this, I'll migrate data later", Opt_In::TEXT_DOMAIN ); ?></a></p>
				...
				<li data-slide="3">
							...
							<ul>
								...
								<li><label for="hustle-new-popup" class="sui-box-selector">
									...
									<span>
										...
										<?php esc_html_e( 'Pop-up', Opt_In::TEXT_DOMAIN ); ?>
									</span>
								</label></li>
								...
								<li><label for="hustle-new-slidein" class="sui-box-selector">
									...
									<span>
										...
										<?php esc_html_e( 'Slide-in', Opt_In::TEXT_DOMAIN ); ?>
									</span>
								</label></li>
								...
								<li><label for="hustle-new-embed" class="sui-box-selector">
									...
									<span>
										...
										<?php esc_html_e( 'Embed', Opt_In::TEXT_DOMAIN ); ?>
									</span>
								</label></li>
								...
								<li><label for="hustle-new-sshare" class="sui-box-selector">
									...
									<span>
										...
										<?php esc_html_e( 'Social Share', Opt_In::TEXT_DOMAIN ); ?>
									</span>
								</label></li>
					...
					<p class="sui-onboard-skip"><a href="#" data-a11y-dialog-hide="hustle-dialog--migrate"><?php esc_html_e( 'Skip this, I will create a module later', Opt_In::TEXT_DOMAIN ); ?></a></p>
