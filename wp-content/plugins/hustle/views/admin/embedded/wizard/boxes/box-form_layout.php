		...
		<div class="wpmudev-box-layouts">
			...
			<div class="wpmudev-box-layout_one {{ ( form_layout === 'one' ) ? 'active' : '' }}">
				...
				<div class="wpmudev-input_radio">
                    ...
                    <input type="radio" id="wph-aftercontent-layout_one" name="form_layout" value="one" data-attribute="form_layout" {{_.checked( (form_layout === 'one') , true)}}>
			...
			<div class="wpmudev-box-layout_two {{ ( form_layout === 'two' ) ? 'active' : '' }}">
				...
				<div class="wpmudev-input_radio">
                    ...
                    <input type="radio" id="wph-aftercontent-layout_two" name="form_layout" value="two" data-attribute="form_layout" {{_.checked( (form_layout === 'two') , true)}}>
			...
			<div class="wpmudev-box-layout_three {{ ( form_layout === 'three' ) ? 'active' : '' }}">
				...
				<div class="wpmudev-input_radio">
                    ...
                    <input type="radio" id="wph-aftercontent-layout_three" name="form_layout" value="three" data-attribute="form_layout" {{_.checked( (form_layout === 'three') , true)}}>
			...
			<div class="wpmudev-box-layout_four {{ ( form_layout === 'four' ) ? 'active' : '' }}">
				...
				<div class="wpmudev-input_radio">
                    ...
                    <input type="radio" id="wph-aftercontent-layout_four" name="form_layout" value="four" data-attribute="form_layout" {{_.checked( (form_layout === 'four') , true)}}>
