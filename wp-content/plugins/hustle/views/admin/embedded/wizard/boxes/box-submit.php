<div id="wph-wizard-settings-submit" class="wpmudev-box-content last">
	...
	<div class="wpmudev-box-left">
        ...
        <label class="wpmudev-info"><?php _e( "If your embed contains a form, you can change the on submit behavior here.", Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-box-right">
        ...
        <select class="wpmudev-select" data-attribute="on_submit" >
            <option value="close" {{ ( on_submit === 'close' ) ? 'selected' : '' }} ><?php _e( "Close the embed", Opt_In::TEXT_DOMAIN ); ?></option>
