<div id="wph-wizard-design-palette" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-left">
		...
		<label class="wpmudev-helper"><?php _e( "Choose a pre-made palette for your Pop-up and further customize it’s appearance.", Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<label class="wpmudev-switch-label" for="wph-popup-custom_palette"><?php _e( "Customize colors", Opt_In::TEXT_DOMAIN ); ?></label>
