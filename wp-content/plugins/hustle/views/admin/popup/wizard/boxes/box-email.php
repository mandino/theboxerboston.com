...
<div id="wph-wizard-content-email" class="wpmudev-box-content {{ ( _.isFalse(use_email_collection) ? 'last' : '' ) }}">
	...
	<div class="wpmudev-box-left">
		...
		<label class="wpmudev-helper"><?php _e( "Configure if you want to collect emails from visitors who see this pop-up and how you want those emails to be stored.", Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<label class="wpmudev-switch-label" for="wph-popup-email_collection"><?php _e( "Add email collection to this pop-up", Opt_In::TEXT_DOMAIN ); ?></label>
...
<?php $this->render( "admin/popup/wizard/boxes/box-form_elements", array(
    'module'  => $module,
