<div id="wph-wizard-design-size" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-left">
		...
		<h4><strong><?php _e( "Custom pop-up size", Opt_In::TEXT_DOMAIN ); ?></strong></h4>
	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<label class="wpmudev-switch-label" for="wph-popup-custom_size"><?php _e( "Use custom size", Opt_In::TEXT_DOMAIN ); ?></label>
