...
<div id="analytics-box" class="sui-box hustle-settings-tab-analytics" data-tab="analytics" <?php if ( $section && 'analytics' !== $section ) echo 'style="display: none;"'; ?>>
	...
	<form data-nonce="<?php echo esc_attr( wp_create_nonce( 'hustle-settings' ) ); ?>">
		...
		<div class="sui-box-header">
			<h2 class="sui-box-title"><?php esc_html_e( 'Dashboard Analytics Tracking', Opt_In::TEXT_DOMAIN ); ?></h2>
		</div>

		<div class="sui-box-body">

			<p><?php esc_html_e( "Add analytics tracking for your Hustle modules that doesn't require any third party integration, and display the data in the WordPress Admin Dashboard area.", Opt_In::TEXT_DOMAIN ); ?>
			...
			<?php if ( $is_enabled ) { ?>
				...
				<div class="sui-box-settings-row">
					...
					<div class="sui-box-settings-col-2">
						...
						<div class="sui-notice sui-notice-success">
							<p><?php echo esc_html( sprintf( __( 'Analytics are now being tracked and the widget is being displayed to users with the "%s" role and above in the Dashboard area.', Opt_In::TEXT_DOMAIN ), ( isset( $settings['role'] ) && $settings['role'] ? ucfirst( $settings['role'] ) : 'Administrator' ) ) ); ?></p>
						</div>
				...
				<p>
					<button class="sui-button sui-button-blue hustle-settings-save-analytics" data-enabled="1">
						<span class="sui-loading-text"><?php esc_html_e( 'Activate', Opt_In::TEXT_DOMAIN ); ?></span>
		...
		<?php if ( $is_enabled ) { ?>
			...
			<div class="sui-box-footer">
				...
				<button class="sui-button sui-button-ghost hustle-settings-save-analytics" data-enabled="0">
					<span class="sui-loading-text"><?php esc_html_e( 'Deactivate', Opt_In::TEXT_DOMAIN ); ?></span>
					<i class="sui-icon-loader sui-loading" aria-hidden="true"></i>
				</button>
