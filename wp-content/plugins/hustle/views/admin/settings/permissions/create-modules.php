<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-1">
		<span class="sui-settings-label"><?php esc_html_e( 'Create Modules', Opt_In::TEXT_DOMAIN ); ?></span>
		<span class="sui-description"><?php esc_html_e( 'Choose the user roles which can create new modules.', Opt_In::TEXT_DOMAIN ); ?></span>
	</div>
