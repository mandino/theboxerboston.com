	...
	<div role="dialog"
		...
		<div class="sui-box" role="document">
			...
			<div class="sui-box-header sui-block-content-center">
				...
				<h3 id="dialogTitle" class="sui-box-title"><?php esc_html_e( 'Choose Conditions', Opt_In::TEXT_DOMAIN ); ?></h3>
			...
			<div class="sui-box-body sui-box-body-slim sui-block-content-center">
				...
				<p id="dialogTitle"><small><?php printf( esc_html__( 'Choose the visibility conditions which you want to apply on the %s.', Opt_In::TEXT_DOMAIN ), esc_html( $smallcaps_singular ) ); ?></small></p>
			...
			<div class="sui-box-selectors sui-box-selectors-col-2">
				...
				<ul class="sui-spacing-slim">
					...
					<li><label for="hustle-condition--posts" class="sui-box-selector">
						...
						<span><?php esc_html_e( 'Posts', Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--pages" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( 'Pages', Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--categories" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( 'Category', Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--tags" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( 'Tags', Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--visitor_logged_in_status" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( "Visitor's logged in status", Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--shown_less_than" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( 'Number of times visitor has seen', Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--visitor_device" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( "Visitor's Device", Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--from_referrer" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( 'Referrer', Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--source_of_arrival" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( 'Source of Arrival', Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--on_url" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( 'Specific URL', Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--visitor_commented" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( 'Visitor Commented Before', Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					...
					<li><label for="hustle-condition--visitor_country" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( "Visitor's Country", Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
					<li><label for="hustle-condition--page_404" class="sui-box-selector">
						<input type="checkbox"
							...
							class="hustle-visibility-condition-option" />
						<span><?php esc_html_e( "404 page", Opt_In::TEXT_DOMAIN ); ?></span>
					</label></li>
			...
			<div class="sui-box-footer">
				...
				<button id="hustle-add-conditions" class="sui-button">
					<span class="sui-loading-text"><?php esc_attr_e( 'Add Conditions', Opt_In::TEXT_DOMAIN); ?></span>
