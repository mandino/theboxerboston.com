<div id="wph-wizard-settings-triggers" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-left">
		...
		<h4><strong><?php _e( "Slide-in triggers", Opt_In::TEXT_DOMAIN ); ?></strong></h4>

        <label class="wpmudev-helper"><?php _e( "Slide-ins can be triggered after a certain amount of Time, when the user Scrolls past an element, on Click, if the user tries to Leave or if we detect AdBlock", Opt_In::TEXT_DOMAIN ); ?></label>
            ...
            <div class="wpmudev-tabs-content">
                ...
                <div id="wpmudev-display-trigger-time" class="wpmudev-tabs-content_item {{ ( triggers.trigger === 'time' ) ? 'current' : '' }}">
                    ...
                    <div class="wpmudev-switch-labeled top">
                        ...
                        <div class="wpmudev-switch-labels">
                            ...
                            <label class="wpmudev-switch-label" for="wph-slidein-trigger_time"><?php _e( "Show after certain time", Opt_In::TEXT_DOMAIN ); ?></label>

                            <label class="wpmudev-helper"><?php _e( "If switched off, Slide-in will be shown as soon as page is loaded.", Opt_In::TEXT_DOMAIN ); ?></label>
                    ...
                    <div id="wpmudev-display-trigger-time-options" class="wpmudev-box-gray {{ ( _.isTrue(triggers.on_time) ) ? 'wpmudev-show' : 'wpmudev-hidden' }}">
                        ...
                        <label><?php _e( "Show Slide-in after", Opt_In::TEXT_DOMAIN ); ?></label>
                ...
                <div id="wpmudev-display-trigger-scroll" class="wpmudev-tabs-content_item {{ ( triggers.trigger === 'scroll' ) ? 'current' : '' }}">
                    ...
                    <div id="wpmudev-display-trigger-scroll-options" class="wpmudev-box-gray">
							...
							<label class="{{ ( triggers.on_scroll !== 'scrolled' ) ? 'wpmudev-hidden' : 'wpmudev-show' }}"><?php _e( "Show slide-in after page has been scrolled", Opt_In::TEXT_DOMAIN ); ?></label>

                            <label class="{{ ( triggers.on_scroll !== 'selector' ) ? 'wpmudev-hidden' : 'wpmudev-show' }}"><?php _e( "Show slide-in after user passed a CSS selector", Opt_In::TEXT_DOMAIN ); ?></label>
                ...
                <div id="wpmudev-display-trigger-exit_intent" class="wpmudev-tabs-content_item {{ ( triggers.trigger === 'exit_intent' ) ? 'current' : '' }}">
                    ...
                    <div class="wpmudev-switch-labeled">
                        ...
                        <label class="wpmudev-switch-label" for="wph-slidein-trigger_session"><?php _e( "Trigger once per session only", Opt_In::TEXT_DOMAIN ); ?></label>
					...
					<div class="wpmudev-switch-labeled">
                        ...
                        <div class="wpmudev-switch-labels">
                            ...
                            <label class="wpmudev-switch-label" for="wph-slidein-on_exit_intent_delayed"><?php _e( "Add delay", Opt_In::TEXT_DOMAIN ); ?></label>
                ...
                <div id="wpmudev-display-trigger-adblock" class="wpmudev-tabs-content_item {{ ( triggers.trigger === 'adblock' ) ? 'current' : '' }}">
                    ...
                    <div class="wpmudev-switch-labeled">
                        ...
                        <label class="wpmudev-switch-label" for="wph-slidein-trigger_adblock"><?php _e( "Trigger when AdBlock is detected", Opt_In::TEXT_DOMAIN ); ?></label>
