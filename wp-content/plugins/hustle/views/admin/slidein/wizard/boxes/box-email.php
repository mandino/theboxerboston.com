...
<div id="wph-wizard-content-email" class="wpmudev-box-content {{ ( _.isFalse(use_email_collection) ? 'last' : '' ) }}">
	...
	<div class="wpmudev-box-left">
		...
		<label class="wpmudev-helper"><?php _e( "Configure if you want to collect emails from visitors who see this Slide-in and how you want those emails to be stored.", Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<label class="wpmudev-switch-label" for="wph-slidein-email_collection"><?php _e( "Add email collection to this Slide-in", Opt_In::TEXT_DOMAIN ); ?></label>
...
<?php $this->render( "admin/slidein/wizard/boxes/box-form_elements", array(
    'module'  => $module,
