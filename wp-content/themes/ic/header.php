			...
			<div class="ressys">
				...
				<!-- flex dates -->
					...
					<div class="reservationform flexdate">
						...
						<p><a href="https://theboxerboston.reztrip.com" onClick="ga('send', 'event', 'Booking-widget', 'Flexible Dates', 'click');">Flexible dates?</a> Search for our best available rate</p>
