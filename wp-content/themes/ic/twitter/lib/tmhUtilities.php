...
class tmhUtilities {
      ...
      foreach ($things as $entity => $value) {
        ...
        switch ($type) {
          ...
          case 'media':
            ...
            $display = isset($value['display_url']) ? $value['display_url'] : str_replace('//', '', $url);
   ...
   * @return string
   * @url //www.dasprids.de/blog/2008/08/22/getting-a-password-hidden-from-stdin-with-php-cli
   */
