					...
					<div class="imagegal thumbgal">
						...
						<ul>
							...
							<li>
								...
								<a href="<?php the_permalink(); ?>"><img src="<?php echo tt(get_post_meta($post->ID, 'cebo_homethumb', true), 262, 290); ?>" alt="<?php echo get_image_alt_text($post->ID) ?>" style="width: 100%"></a>
								
								<?php } else { ?>
								
								<a href="<?php the_permalink(); ?>"><img src="<?php echo tt($imgsrc[0], 262, 290); ?>" alt="<?php echo get_image_alt_text($post->ID) ?>" style="width: 100%"></a>
